...
public class AddBook extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        btnAdd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bookstore/ui/add-icon.png"))); // NOI18N
        btnAdd.setText("Add");
        ...
        btnDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/bookstore/ui/delete_icon.png"))); // NOI18N
                ...
                if (txtAuthor.getText().matches("[0-9a-zA-Z áàạảãâấậẩầẫăắằẳẵặđéẻèẽẹêểếềễệìỉíịĩòóỏõọôổốồỗộơởớờỡợùủúụũưửừứựữýỷỵỹỳÁẢẠÀÃẤẦẬẨẪÂĂẲẮẰẴẶĐÉẺÈẸẼÊỂẾỀỆỄÍỈÌỊĨÓÒỎỌÕÔỐỔỒỘỖƠỜỞỚỢỠÚỦÙỤŨƯỪỨỬỰỮÝỶỲỴỸ]+")) {
                    if (txtDate.getText().matches("^[0-9]{1,2}/[0-9]{1,2}/[0-9]{4}$")) {
                        if (txtAmount.getText().matches("[0-9]{1,}")) {
                            ...
                            JOptionPane.showMessageDialog(null, "Format for invalid \"Amount\" ! Please check again ! ");
                        }
                    } else {
                        JOptionPane.showMessageDialog(null, "Format for invalid \"Date\" ! Please check again ! ");
                    }
                } else {
                    JOptionPane.showMessageDialog(null, "Format for invalid \"Author\" ! Please check again ! ");
                }
            } else {
                JOptionPane.showMessageDialog(null, "Format for invalid \"Price\" ! Please check again ! ");
            }
        } else {
            JOptionPane.showMessageDialog(null, "Format for invalid \"Name\" ! Please check again ! ");
        }
